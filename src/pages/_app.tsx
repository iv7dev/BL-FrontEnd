    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="The most popular AMM on BSC! Earn GSYS through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by Genesys Network), NFTs, and more, on a platform you can trust."
        />
