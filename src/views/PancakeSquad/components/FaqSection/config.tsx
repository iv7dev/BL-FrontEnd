...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Genesys Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Genesys Bunny NFTs at the snapshot may also purchase one additional Genesys Squad NFT in the presale for each Genesys Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of GSYS spent on Genesys Squad NFTs will be burned as part of our weekly GSYS burn.')],
  },
  {
