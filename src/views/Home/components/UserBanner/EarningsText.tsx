...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and GSYS pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and GSYS pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from GSYS pool', data)
  }
